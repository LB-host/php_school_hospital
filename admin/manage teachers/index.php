<?php
require_once "./view-teachers/view_teachers_action.php"
?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <body>
    ...
    <div class="table-container">
        ...
        <script>
          ...
          function adddoctor() {
            window.location.href = "./add-teacher/index.html";
          }

          function viewdoctor(doctorID) {
            window.location.href = "./view-teacher/index.php?doctorID=" + doctorID;
          }

          function deletedoctor(doctorID) {

            fetch("./delete-teacher/delete_teacher_action.php?doctorID=" + doctorID , {
              method: "GET"
            })
